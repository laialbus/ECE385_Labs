...
BYTE XferDispatchPkt( BYTE token, BYTE ep )
{
 ...
 //DWORD timeout = (XTmrCtr_GetValue(&Usb_timer, 0)/TICKS_PER_MILLIS) + 50;
 BYTE tmpdata;
 BYTE rcode;
 char retry_count = 0;
 BYTE nak_count = 0;
 ...
 //int  ctr = 0;
    ...
    while( 1 ) {
        ...
        /////////////////////////////////////////////////////////////////////////////
//        XTmrCtr timer;
//        u32 start_time, end_time, cycles;
//        cycles = 0;
...
//		xil_printf("Dispatch: %d ---- cycles %d", end_time - start_time, cycles);
//        /////////////////////////////////////////////////////////////////////////////
